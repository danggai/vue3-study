<template>
  <f7-page name="home">
    ...
    <f7-navbar large :sliding="false">
      <f7-nav-left>
        <f7-link icon-ios="f7:menu" icon-md="material:menu"
          panel-open="left"></f7-link>
      </f7-nav-left>
      <f7-nav-title sliding>framework7-test</f7-nav-title>
      <f7-nav-right>
        <f7-link icon-ios="f7:menu" icon-md="material:menu"
          panel-open="right"></f7-link>
      </f7-nav-right>
      <f7-nav-title-large>framework7-test</f7-nav-title-large>
    </f7-navbar>
    <!-- Toolbar-->
    <f7-toolbar bottom>
    ...
    <f7-block class="grid grid-cols-2 grid-gap">
      ...
      <f7-button fill login-screen-open="#my-login-screen">Login
        Screen</f7-button>
    </f7-block>
